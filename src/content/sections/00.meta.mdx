...
Okay, let's test out a <CitationLink href="#example-citation" title="Card Title" client:visible>Citation</CitationLink>. _(hover to preview, click to navigate)_

And then let's test a <CitationLink href="#second-citation" title="Second Citation" client:visible>Second Citation</CitationLink>. _< why the extra space before the period here?_